...
<body class="fixed-header">
    <div class="login-wrapper">
        <div class="bg-pic">
            <img src="{{ asset('assets/dashboard/img/wallpaper.jpeg') }}" data-src="{{ asset('assets/dashboard/img/wallpaper.jpeg') }}" data-src-retina="{{ asset('assets/dashboard/img/wallpaper.jpeg') }}" alt="" class="lazy">
        </div>
